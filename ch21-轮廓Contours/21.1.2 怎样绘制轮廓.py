...
contours2=[cnt for cnt in contours if cv2.contourArea(cnt)>5000]#过滤太小的contour
print('filter too small contour', len(contours2))

# cv2.drawContours(imgray, contours, -1, (0, 0,255), 3)
cv2.drawContours(im, contours2, -1, (255, 0, 0), 3)
